...
<qgis simplifyMaxScale="1" simplifyAlgorithm="0" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" minScale="100000000" symbologyReferenceScale="-1" readOnly="0" labelsEnabled="0" simplifyDrawingHints="1" simplifyLocal="1" styleCategories="AllStyleCategories" version="3.22.11-Białowieża" maxScale="0">
  ...
  <referencedLayers>
    <relation referencingLayer="Stadt_3877f3bd_b7c6_43d3_863f_aff1a2f92764" name="stadt_rsprovinz_fkey" providerKey="ogr" dataSource="./gaga9.gpkg|layername=provinz" referencedLayer="Provinz___Bundesland___Kanton_4b6f525d_82bf_4d20_9e0f_08e99ce6700c" strength="Association" layerName="Provinz / Bundesland / Kanton" id="stadt_rsprovinz_fkey" layerId="Provinz___Bundesland___Kanton_4b6f525d_82bf_4d20_9e0f_08e99ce6700c">
      <fieldRef referencedField="t_id" referencingField="rsprovinz"/>
    </relation>
    <relation referencingLayer="Stadt_3877f3bd_b7c6_43d3_863f_aff1a2f92764" name="stadt_rsprovinz_provinz_T_Id" providerKey="ogr" dataSource="./gaga9.gpkg|layername=provinz" referencedLayer="Provinz___Bundesland___Kanton_4b6f525d_82bf_4d20_9e0f_08e99ce6700c" strength="Composition" layerName="Provinz / Bundesland / Kanton" id="stadt_rsprovinz_provinz_T_Id" layerId="Provinz___Bundesland___Kanton_4b6f525d_82bf_4d20_9e0f_08e99ce6700c">
      <fieldRef referencedField="T_Id" referencingField="rsprovinz"/>
    </relation>
  </referencedLayers>
  <fieldConfiguration>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="Relation" type="QString" value="stadt_rsprovinz_fkey"/>
  ...
  <aliases>
    ...
    <alias name="Wohnbevölkerung absolut" field="bevoelkerung_gesamt" index="2"/>
    <alias name="Name der Stadt" field="stadtname" index="3"/>
    <alias name="rSProvinz" field="rsprovinz" index="4"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint constraints="1" field="rsprovinz" exp_strength="0" unique_strength="0" notnull_strength="1"/>
  </constraints>
  ...
  <attributeEditorForm>
    ...
    <attributeEditorField name="bevoelkerung_gesamt" index="2" showLabel="1"/>
    <attributeEditorField name="stadtname" index="3" showLabel="1"/>
    <attributeEditorField name="rsprovinz" index="4" showLabel="1"/>
  </attributeEditorForm>
  <editable/>
  <labelOnTop/>
  <reuseLastValue/>
