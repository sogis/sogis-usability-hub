...
<qgis readOnly="0" styleCategories="LayerConfiguration|Symbology|Fields|Forms|CustomProperties|GeometryOptions" version="3.28.6-Firenze">
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" name="ReferencedLayerDataSource" value="//srsofaioi15496/xenusers$/bjsvwweb/Documents/02_Projekte/2075_Schutzbautenkataster/SO_AFU_Schutzbauten_20240206.gpkg|layername=wasser_rueckhaltebauwerk_art"/>
            <Option type="QString" name="ReferencedLayerId" value="Wasser_Rueckhaltebauwerk_Art_5546f02d_3fcc_405d_9b9c_fcc21e455b4a"/>
            <Option type="QString" name="ReferencedLayerName" value="Wasser_Rueckhaltebauwerk_Art"/>
            <Option type="QString" name="ReferencedLayerProviderKey" value="ogr"/>
            <Option type="QString" name="Relation" value="wasser_rueckhaltebauwerk_art_wasser_rueckhaltebauwerk_art_T_Id"/>
  ...
  <constraints>
    ...
    <constraint field="rueckhaltevolumen" exp_strength="0" constraints="1" unique_strength="0" notnull_strength="1"/>
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer visibilityExpressionEnabled="0" groupBox="0" visibilityExpression="" collapsed="0" name="General" collapsedExpression="" collapsedExpressionEnabled="0" showLabel="1" columnCount="2">
      ...
      <attributeEditorContainer visibilityExpressionEnabled="0" groupBox="1" visibilityExpression="" collapsed="0" name="Bauwerkspezifisch" collapsedExpression="" collapsedExpressionEnabled="0" showLabel="1" columnCount="1">
        ...
        <attributeEditorField name="rueckhaltevolumen" showLabel="1" index="5">
          <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
            <labelFont description="Ubuntu,11,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
