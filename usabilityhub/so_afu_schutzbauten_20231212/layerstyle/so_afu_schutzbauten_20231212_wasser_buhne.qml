...
<qgis maxScale="0" simplifyAlgorithm="0" readOnly="0" styleCategories="AllStyleCategories" version="3.28.6-Firenze" simplifyDrawingTol="1" minScale="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyMaxScale="1" symbologyReferenceScale="-1" simplifyLocal="1" simplifyDrawingHints="1">
  <flags>
      ...
      <symbol alpha="1" type="line" name="0" force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1">
        ...
        <layer pass="0" locked="0" class="SimpleLine" enabled="1">
          <Option type="Map">
            ...
            <Option type="QString" name="draw_inside_polygon" value="0"/>
            <Option type="QString" name="joinstyle" value="bevel"/>
            <Option type="QString" name="line_color" value="89,87,255,255"/>
            <Option type="QString" name="line_style" value="solid"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory diagramOrientation="Up" enabled="0" maxScaleDenominator="0" penWidth="0" labelPlacementMethod="XHeight" spacingUnit="MM" sizeType="MM" lineSizeType="MM" opacity="1" spacing="5" sizeScale="3x:0,0,0,0,0,0" width="15" minimumSize="0" spacingUnitScale="3x:0,0,0,0,0,0" backgroundColor="#ffffff" showAxis="1" backgroundAlpha="255" height="15" direction="0" lineSizeScale="3x:0,0,0,0,0,0" minScaleDenominator="0" penAlpha="255" penColor="#000000" barWidth="5" scaleBasedVisibility="0" scaleDependency="Area" rotationOffset="270">
      <fontProperties description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" bold="0" underline="0" style=""/>
  ...
  <DiagramLayerSettings showAll="1" priority="0" linePlacementFlags="18" obstacle="0" dist="0" placement="2" zIndex="0">
    <properties>
      <Option type="Map">
        <Option type="QString" name="name" value=""/>
        <Option name="properties"/>
  ...
  <referencedLayers>
    <relation layerName="Koerperschaft_Typ" providerKey="ogr" referencingLayer="Wasser_Buhne_6bf0ab6c_62c2_4c3f_95da_f3fbb02e8adc" id="wasser_buhne_erhaltungsverantwortung_kategorie_koerperschaft_typ_T_Id" dataSource="./SO_AFU_Schutzbauten_20240206.gpkg|layername=koerperschaft_typ" strength="Association" name="wasser_buhne_erhaltungsverantwortung_kategorie_koerperschaft_typ_T_Id" referencedLayer="Koerperschaft_Typ_12bc44a4_ae62_443e_99a3_e9bd2f80b40b" layerId="Koerperschaft_Typ_12bc44a4_ae62_443e_99a3_e9bd2f80b40b">
      <fieldRef referencingField="erhaltungsverantwortung_kategorie" referencedField="T_Id"/>
    </relation>
    <relation layerName="Baumaterial_Typ" providerKey="ogr" referencingLayer="Wasser_Buhne_6bf0ab6c_62c2_4c3f_95da_f3fbb02e8adc" id="wasser_buhne_material_baumaterial_typ_T_Id" dataSource="./SO_AFU_Schutzbauten_20240206.gpkg|layername=baumaterial_typ" strength="Association" name="wasser_buhne_material_baumaterial_typ_T_Id" referencedLayer="Baumaterial_Typ_ececce78_f771_40a6_97e9_325e1522c017" layerId="Baumaterial_Typ_ececce78_f771_40a6_97e9_325e1522c017">
      <fieldRef referencingField="material" referencedField="T_Id"/>
    </relation>
    <relation layerName="Wirksamkeit_Typ" providerKey="ogr" referencingLayer="Wasser_Buhne_6bf0ab6c_62c2_4c3f_95da_f3fbb02e8adc" id="wasser_buhne_wirksamkeit_wirksamkeit_typ_T_Id" dataSource="./SO_AFU_Schutzbauten_20240206.gpkg|layername=wirksamkeit_typ" strength="Association" name="wasser_buhne_wirksamkeit_wirksamkeit_typ_T_Id" referencedLayer="Wirksamkeit_Typ_b9008206_2a38_4fc3_8c0a_5594b4e46dd8" layerId="Wirksamkeit_Typ_b9008206_2a38_4fc3_8c0a_5594b4e46dd8">
      <fieldRef referencingField="wirksamkeit" referencedField="T_Id"/>
    </relation>
    <relation layerName="Beurteilung_Typ" providerKey="ogr" referencingLayer="Wasser_Buhne_6bf0ab6c_62c2_4c3f_95da_f3fbb02e8adc" id="wasser_buhne_zustand_beurteilung_typ_T_Id" dataSource="./SO_AFU_Schutzbauten_20240206.gpkg|layername=beurteilung_typ" strength="Association" name="wasser_buhne_zustand_beurteilung_typ_T_Id" referencedLayer="Beurteilung_Typ_3afdbb2b_1f30_445c_8c52_055005154f83" layerId="Beurteilung_Typ_3afdbb2b_1f30_445c_8c52_055005154f83">
      <fieldRef referencingField="zustand" referencedField="T_Id"/>
    </relation>
  </referencedLayers>
  <fieldConfiguration>
  ...
  <constraints>
    ...
    <constraint field="laenge" exp_strength="0" constraints="1" unique_strength="0" notnull_strength="1"/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column type="field" hidden="0" width="-1" name="weiterer_prozess_rutschung"/>
      <column type="field" hidden="0" width="-1" name="weiterer_prozess_sturz"/>
      <column type="field" hidden="0" width="-1" name="schutzbauten_id"/>
      <column type="field" hidden="0" width="-1" name="material"/>
      <column type="field" hidden="0" width="-1" name="erstellungsjahr"/>
      <column type="field" hidden="0" width="-1" name="erhaltungsverantwortung_kategorie"/>
      <column type="field" hidden="0" width="-1" name="erhaltungsverantwortung_name"/>
      <column type="field" hidden="0" width="-1" name="zustand"/>
      <column type="field" hidden="0" width="-1" name="zustandsbeurteilung_jahr"/>
      <column type="field" hidden="0" width="-1" name="bemerkungen"/>
      <column type="field" hidden="0" width="-1" name="wirksamkeit"/>
    ...
    <attributeEditorContainer visibilityExpressionEnabled="0" groupBox="0" visibilityExpression="" collapsed="0" name="General" collapsedExpression="" collapsedExpressionEnabled="0" showLabel="1" columnCount="2">
      ...
      <attributeEditorContainer visibilityExpressionEnabled="0" groupBox="1" visibilityExpression="" collapsed="0" name="Allgemein" collapsedExpression="" collapsedExpressionEnabled="0" showLabel="1" columnCount="1">
        ...
        <attributeEditorContainer visibilityExpressionEnabled="0" groupBox="1" visibilityExpression="" collapsed="0" name="Weitere Prozesse" collapsedExpression="" collapsedExpressionEnabled="0" showLabel="1" columnCount="2">
          ...
          <attributeEditorField name="weiterer_prozess_rutschung" showLabel="1" index="3">
            <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
              <labelFont description="Ubuntu,11,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" bold="0" underline="0" style=""/>
            </labelStyle>
          </attributeEditorField>
          <attributeEditorField name="weiterer_prozess_sturz" showLabel="1" index="4">
            <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
              <labelFont description="Ubuntu,11,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" bold="0" underline="0" style=""/>
            </labelStyle>
          </attributeEditorField>
        </attributeEditorContainer>
        <attributeEditorField name="schutzbauten_id" showLabel="1" index="5">
          <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
            <labelFont description="Ubuntu,11,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="material" showLabel="1" index="6">
          <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
            <labelFont description="Ubuntu,11,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="erstellungsjahr" showLabel="1" index="7">
          <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
            <labelFont description="Ubuntu,11,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="erhaltungsverantwortung_kategorie" showLabel="1" index="8">
          <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
            <labelFont description="Ubuntu,11,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="erhaltungsverantwortung_name" showLabel="1" index="9">
          <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
            <labelFont description="Ubuntu,11,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="zustand" showLabel="1" index="10">
          <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
            <labelFont description="Ubuntu,11,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="zustandsbeurteilung_jahr" showLabel="1" index="11">
          <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
            <labelFont description="Ubuntu,11,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="wirksamkeit" showLabel="1" index="13">
          <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
            <labelFont description="Ubuntu,11,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="bemerkungen" showLabel="1" index="12">
          <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
            <labelFont description="Ubuntu,11,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
      ...
      <attributeEditorContainer visibilityExpressionEnabled="0" groupBox="1" visibilityExpression="" collapsed="0" name="Bauwerkspezifisch" collapsedExpression="" collapsedExpressionEnabled="0" showLabel="1" columnCount="1">
        ...
        <attributeEditorField name="breite" showLabel="1" index="-1">
          <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
            <labelFont description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="hoehe" showLabel="1" index="-1">
          <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
            <labelFont description="Ubuntu,11,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="hoehe_zum_umland" showLabel="1" index="-1">
          <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
            <labelFont description="Ubuntu,11,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="flaeche" showLabel="1" index="-1">
          <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
            <labelFont description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="rueckhaltevolumen" showLabel="1" index="-1">
          <labelStyle overrideLabelFont="0" overrideLabelColor="0" labelColor="0,0,0,255">
            <labelFont description="Ubuntu,11,-1,5,50,0,0,0,0,0" strikethrough="0" italic="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
