...
<qgis readOnly="0" styleCategories="LayerConfiguration|Symbology|Fields|Forms|CustomProperties|GeometryOptions" version="3.28.6-Firenze">
  ...
  <aliases>
    ...
    <alias index="13" name="Zustandsbeurteilung_Jahr" field="zustandsbeurteilung_jahr"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="laenge" notnull_strength="2" constraints="1" exp_strength="0"/>
    <constraint unique_strength="0" field="breite" notnull_strength="2" constraints="1" exp_strength="0"/>
    <constraint unique_strength="0" field="hoehe" notnull_strength="2" constraints="1" exp_strength="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpression="" showLabel="1" collapsedExpressionEnabled="0" columnCount="2" visibilityExpressionEnabled="0" name="Übersicht" collapsed="0" collapsedExpression="">
      ...
      <attributeEditorContainer groupBox="1" visibilityExpression="" showLabel="1" collapsedExpressionEnabled="0" columnCount="1" visibilityExpressionEnabled="0" name="Allgemein" collapsed="0" collapsedExpression="">
        ...
        <attributeEditorContainer groupBox="1" visibilityExpression="" showLabel="1" collapsedExpressionEnabled="0" columnCount="2" visibilityExpressionEnabled="0" name="Weitere Prozesse" collapsed="0" collapsedExpression="">
          ...
          <attributeEditorField showLabel="1" index="5" name="weiterer_prozess_rutschung">
            <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
              <labelFont italic="0" bold="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" underline="0" style="" strikethrough="0"/>
            </labelStyle>
          </attributeEditorField>
          <attributeEditorField showLabel="1" index="6" name="weiterer_prozess_sturz">
            <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
              <labelFont italic="0" bold="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" underline="0" style="" strikethrough="0"/>
            </labelStyle>
          </attributeEditorField>
        </attributeEditorContainer>
        <attributeEditorField showLabel="1" index="7" name="schutzbauten_id">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
        ...
        <attributeEditorField showLabel="1" index="9" name="erstellungsjahr">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
            <labelFont italic="0" bold="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" underline="0" style="" strikethrough="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField showLabel="1" index="10" name="erhaltungsverantwortung_kategorie">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
            <labelFont italic="0" bold="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" underline="0" style="" strikethrough="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField showLabel="1" index="11" name="erhaltungsverantwortung_name">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
            <labelFont italic="0" bold="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" underline="0" style="" strikethrough="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField showLabel="1" index="12" name="zustand">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
            <labelFont italic="0" bold="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" underline="0" style="" strikethrough="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField showLabel="1" index="13" name="zustandsbeurteilung_jahr">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
            <labelFont italic="0" bold="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" underline="0" style="" strikethrough="0"/>
          </labelStyle>
        </attributeEditorField>
        ...
        <attributeEditorField showLabel="1" index="15" name="wirksamkeit">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
            <labelFont italic="0" bold="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" underline="0" style="" strikethrough="0"/>
          </labelStyle>
        </attributeEditorField>
    ...
    <attributeEditorContainer groupBox="0" visibilityExpression="" showLabel="1" collapsedExpressionEnabled="0" columnCount="1" visibilityExpressionEnabled="0" name="Dokumente zum Bauwerk" collapsed="0" collapsedExpression="">
      ...
      <attributeEditorRelation showLabel="1" forceSuppressFormPopup="0" nmRelationId="schutzbaute_dokument_dokument_dokument_T_Id" relation="schutzbaute_dokument_schutzbaute_wasser_bruecke_steg_wasser_bruecke_steg_T_Id" name="schutzbaute_dokument_schutzbaute_wasser_bruecke_steg_wasser_bruecke_steg_T_Id" relationWidgetTypeId="linking_relation_editor" label="">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont italic="0" bold="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" underline="0" style="" strikethrough="0"/>
        </labelStyle>
