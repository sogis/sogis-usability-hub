...
<qgis readOnly="0" styleCategories="LayerConfiguration|Symbology|Fields|Forms|CustomProperties|GeometryOptions" version="3.28.6-Firenze">
  ...
  <aliases>
    ...
    <alias index="5" name="weiterer Prozess Rutschung" field="weiterer_prozess_rutschung"/>
    <alias index="6" name="weiterer Prozess Sturz" field="weiterer_prozess_sturz"/>
    <alias index="7" name="Schutzbauten ID" field="schutzbauten_id"/>
    <alias index="8" name="Material" field="material"/>
    <alias index="9" name="Erstellungsjahr [Y]" field="erstellungsjahr"/>
    <alias index="10" name="Erhaltungsverantwortung Kategorie" field="erhaltungsverantwortung_kategorie"/>
    <alias index="11" name="Erhaltungsverantwortung Name" field="erhaltungsverantwortung_name"/>
    <alias index="12" name="Zustand" field="zustand"/>
    <alias index="13" name="Zustandsbeurteilung Jahr [Y]" field="zustandsbeurteilung_jahr"/>
