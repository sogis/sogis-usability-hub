...
<qgis styleCategories="LayerConfiguration|Symbology|Fields|Forms|CustomProperties|GeometryOptions" version="3.28.6-Firenze" readOnly="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" type="singleSymbol" referencescale="-1">
    <symbols>
      <symbol type="marker" is_animated="0" clip_to_extent="1" name="0" alpha="1" force_rhr="0" frame_rate="10">
        ...
        <layer enabled="1" locked="0" pass="0" id="{24550f16-a265-4d58-89f3-655b84a24476}" class="SimpleMarker">
          <Option type="Map">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol type="marker" is_animated="0" clip_to_extent="1" name="" alpha="1" force_rhr="0" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" pass="0" id="{04b70f08-3c69-4779-88cf-0b3bcd862c6b}" class="SimpleMarker">
          <Option type="Map">
            <Option type="QString" value="0" name="angle"/>
            <Option type="QString" value="square" name="cap_style"/>
  ...
  <aliases>
    ...
    <alias field="hoehe" index="4" name="Höhe [m]"/>
    <alias field="hoehe_zum_umland" index="5" name="Höhe zum Umland [m]"/>
    <alias field="flaeche" index="6" name="Fläche [m2]"/>
    <alias field="rueckhaltevolumen" index="7" name="Rückhaltevolumen [m3]"/>
    <alias field="weiterer_prozess_wasser" index="8" name="weiterer Prozess Wasser"/>
    <alias field="weiterer_prozess_sturz" index="9" name="weiterer Prozess Sturz"/>
    <alias field="schutzbauten_id" index="10" name="Schutzbauten ID"/>
    <alias field="material" index="11" name="Material"/>
    <alias field="erstellungsjahr" index="12" name="Erstellungsjahr [Y]"/>
    <alias field="erhaltungsverantwortung_kategorie" index="13" name="Erhaltungsverantwortung Kategorie"/>
    <alias field="erhaltungsverantwortung_name" index="14" name="Erhaltungsverantwortung Name"/>
    <alias field="zustand" index="15" name="Zustand"/>
    <alias field="zustandsbeurteilung_jahr" index="16" name="Zustandsbeurteilung Jahr [Y]"/>
  ...
  <splitPolicies>
    ...
    <policy field="laenge" policy="DefaultValue"/>
    <policy field="breite" policy="DefaultValue"/>
    <policy field="hoehe" policy="DefaultValue"/>
    <policy field="hoehe_zum_umland" policy="DefaultValue"/>
    <policy field="flaeche" policy="DefaultValue"/>
    <policy field="rueckhaltevolumen" policy="DefaultValue"/>
    <policy field="weiterer_prozess_wasser" policy="DefaultValue"/>
    <policy field="weiterer_prozess_sturz" policy="DefaultValue"/>
    <policy field="schutzbauten_id" policy="DefaultValue"/>
    <policy field="material" policy="DefaultValue"/>
    <policy field="erstellungsjahr" policy="DefaultValue"/>
    <policy field="erhaltungsverantwortung_kategorie" policy="DefaultValue"/>
    <policy field="erhaltungsverantwortung_name" policy="DefaultValue"/>
    <policy field="zustand" policy="DefaultValue"/>
    <policy field="zustandsbeurteilung_jahr" policy="DefaultValue"/>
    <policy field="bemerkungen" policy="DefaultValue"/>
    <policy field="wirksamkeit" policy="DefaultValue"/>
  </splitPolicies>
  <defaults>
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" visibilityExpression="" collapsed="0" columnCount="1" type="Tab" horizontalStretch="0" showLabel="1" visibilityExpressionEnabled="0" name="Dokumente zum Bauwerk" verticalStretch="0" groupBox="0" collapsedExpression="">
      ...
      <attributeEditorRelation relation="schutzbaute_dokument_schutzbaute_rutschung_andere_werksart_punkt_rutschung_andere_werksart_punkt_T_Id" forceSuppressFormPopup="0" relationWidgetTypeId="linking_relation_editor" horizontalStretch="0" showLabel="1" name="schutzbaute_dokument_schutzbaute_rutschung_andere_werksart_punkt_rutschung_andere_werksart_punkt_T_Id" verticalStretch="0" nmRelationId="schutzbaute_dokument_dokument_dokument_T_Id" label="">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Ubuntu,11,-1,5,50,0,0,0,0,0" style="" underline="0" bold="0" strikethrough="0" italic="0"/>
        </labelStyle>
  ...
  <widgets>
    ...
    <widget name="schutzbaute_dokument_schutzbaute_rutschung_andere_werksart_punkt_rutschung_andere_werksart_punkt_T_Id">
      <config type="Map">
        <Option type="QString" value="schutzbaute_dokument_dokument_dokument_T_Id" name="nm-rel"/>
      </config>
    </widget>
