...
<qgis styleCategories="LayerConfiguration|Symbology|Fields|Forms|CustomProperties|GeometryOptions" version="3.28.6-Firenze" readOnly="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" type="singleSymbol" referencescale="-1">
    <symbols>
      <symbol type="line" is_animated="0" clip_to_extent="1" name="0" alpha="1" force_rhr="0" frame_rate="10">
        ...
        <layer enabled="1" locked="0" pass="0" id="{55ba6c2d-2812-4c29-b615-e4f719fdea7e}" class="SimpleLine">
          <Option type="Map">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol type="line" is_animated="0" clip_to_extent="1" name="" alpha="1" force_rhr="0" frame_rate="10">
        ...
        <layer enabled="1" locked="0" pass="0" id="{7210c736-91c2-4fe9-b95f-f18bee89cc86}" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" value="Rutschung_Hangstuetzwerk_Entwaesserung_Palisade_Art_39124cc9_50a2_4713_837a_64085e103855" name="Layer"/>
            <Option type="QString" value="Rutschung_Hangstuetzwerk_Entwaesserung_Palisade_Art" name="LayerName"/>
  ...
  <aliases>
    ...
    <alias field="weiterer_prozess_wasser" index="4" name="weiterer Prozess Wasser"/>
    <alias field="weiterer_prozess_sturz" index="5" name="weiterer Prozess Sturz"/>
    <alias field="schutzbauten_id" index="6" name="Schutzbauten ID"/>
    <alias field="material" index="7" name="Material"/>
    <alias field="erstellungsjahr" index="8" name="Erstellungsjahr [Y]"/>
    <alias field="erhaltungsverantwortung_kategorie" index="9" name="Erhaltungsverantwortung Kategorie"/>
    <alias field="erhaltungsverantwortung_name" index="10" name="Erhaltungsverantwortung Name"/>
    <alias field="zustand" index="11" name="Zustand"/>
    <alias field="zustandsbeurteilung_jahr" index="12" name="Zustandsbeurteilung Jahr [Y]"/>
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" visibilityExpression="" collapsed="0" columnCount="2" type="Tab" horizontalStretch="0" showLabel="1" visibilityExpressionEnabled="0" name="Übersicht" verticalStretch="0" groupBox="0" collapsedExpression="">
      ...
      <attributeEditorContainer collapsedExpressionEnabled="0" visibilityExpression="" collapsed="0" columnCount="1" type="GroupBox" horizontalStretch="0" showLabel="1" visibilityExpressionEnabled="0" name="Bauwerkspezifisch" verticalStretch="0" groupBox="1" collapsedExpression="">
        ...
        <attributeEditorField horizontalStretch="0" showLabel="1" index="3" name="laenge" verticalStretch="0">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
            <labelFont description="DejaVu Sans,11,-1,5,50,0,0,0,0,0" style="" underline="0" bold="0" strikethrough="0" italic="0"/>
          </labelStyle>
        </attributeEditorField>
    ...
    <attributeEditorContainer collapsedExpressionEnabled="0" visibilityExpression="" collapsed="0" columnCount="1" type="Tab" horizontalStretch="0" showLabel="1" visibilityExpressionEnabled="0" name="Dokumente zum Bauwerk" verticalStretch="0" groupBox="0" collapsedExpression="">
      ...
      <attributeEditorRelation relation="schutzbaute_dokument_schutzbaute_rutschung_hangstuetzwerk_entwassrng_plsade_rutschung_hangstuetzwerk_entwaesserung_palisade_T_Id" forceSuppressFormPopup="0" relationWidgetTypeId="linking_relation_editor" horizontalStretch="0" showLabel="1" name="schutzbaute_dokument_schutzbaute_rutschung_hangstuetzwerk_entwassrng_plsade_rutschung_hangstuetzwerk_entwaesserung_palisade_T_Id" verticalStretch="0" nmRelationId="schutzbaute_dokument_dokument_dokument_T_Id" label="">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255">
          <labelFont description="Ubuntu,11,-1,5,50,0,0,0,0,0" style="" underline="0" bold="0" strikethrough="0" italic="0"/>
        </labelStyle>
