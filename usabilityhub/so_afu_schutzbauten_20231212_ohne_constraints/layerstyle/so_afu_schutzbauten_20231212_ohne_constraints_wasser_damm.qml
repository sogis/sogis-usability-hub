...
<qgis styleCategories="LayerConfiguration|Symbology|Fields|Forms|CustomProperties|GeometryOptions" version="3.28.6-Firenze" readOnly="0">
  ...
  <aliases>
    ...
    <alias name="Laenge" index="2" field="laenge"/>
    <alias name="Breite" index="3" field="breite"/>
    <alias name="Hoehe_zum_Umland" index="4" field="hoehe_zum_umland"/>
    <alias name="weiterer_Prozess_Rutschung" index="5" field="weiterer_prozess_rutschung"/>
    <alias name="weiterer_Prozess_Sturz" index="6" field="weiterer_prozess_sturz"/>
    <alias name="Schutzbauten_ID" index="7" field="schutzbauten_id"/>
    <alias name="Material" index="8" field="material"/>
    <alias name="Erstellungsjahr" index="9" field="erstellungsjahr"/>
    <alias name="Erhaltungsverantwortung_Kategorie" index="10" field="erhaltungsverantwortung_kategorie"/>
    <alias name="Erhaltungsverantwortung_Name" index="11" field="erhaltungsverantwortung_name"/>
    <alias name="Zustand" index="12" field="zustand"/>
    <alias name="Zustandsbeurteilung_Jahr" index="13" field="zustandsbeurteilung_jahr"/>
