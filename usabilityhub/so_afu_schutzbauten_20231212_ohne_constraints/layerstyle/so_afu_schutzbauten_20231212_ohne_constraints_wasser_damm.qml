...
<qgis styleCategories="LayerConfiguration|Symbology|Fields|Forms|CustomProperties|GeometryOptions" version="3.28.6-Firenze" readOnly="0">
  ...
  <aliases>
    ...
    <alias name="Länge [m]" index="2" field="laenge"/>
    <alias name="Breite [m]" index="3" field="breite"/>
    <alias name="Höhe zum Umland [m]" index="4" field="hoehe_zum_umland"/>
    <alias name="weiterer Prozess Rutschung" index="5" field="weiterer_prozess_rutschung"/>
    <alias name="weiterer Prozess Sturz" index="6" field="weiterer_prozess_sturz"/>
    <alias name="Schutzbauten ID" index="7" field="schutzbauten_id"/>
    <alias name="Material" index="8" field="material"/>
    <alias name="Erstellungsjahr [Y]" index="9" field="erstellungsjahr"/>
    <alias name="Erhaltungsverantwortung Kategorie" index="10" field="erhaltungsverantwortung_kategorie"/>
    <alias name="Erhaltungsverantwortung Name" index="11" field="erhaltungsverantwortung_name"/>
    <alias name="Zustand" index="12" field="zustand"/>
    <alias name="Zustandsbeurteilung Jahr [Y]" index="13" field="zustandsbeurteilung_jahr"/>
    <alias name="Bemerkungen" index="14" field="bemerkungen"/>
    <alias name="Wirksamkeit" index="15" field="wirksamkeit"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint notnull_strength="2" unique_strength="0" exp_strength="0" constraints="1" field="hoehe_zum_umland"/>
    <constraint notnull_strength="2" unique_strength="0" exp_strength="0" constraints="1" field="weiterer_prozess_rutschung"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" constraints="0" field="weiterer_prozess_sturz"/>
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer name="Übersicht" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" collapsed="0" columnCount="2" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorContainer name="Allgemein" groupBox="1" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" collapsed="0" columnCount="1" collapsedExpression="" visibilityExpression="" showLabel="1">
        ...
        <attributeEditorContainer name="Weitere Prozesse" groupBox="1" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" collapsed="0" columnCount="2" collapsedExpression="" visibilityExpression="" showLabel="1">
          ...
          <attributeEditorField name="weiterer_prozess_rutschung" index="5" showLabel="1">
            <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
              <labelFont strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
            </labelStyle>
          </attributeEditorField>
          <attributeEditorField name="weiterer_prozess_sturz" index="6" showLabel="1">
            <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
              <labelFont strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
            </labelStyle>
          </attributeEditorField>
        </attributeEditorContainer>
        <attributeEditorField name="schutzbauten_id" index="7" showLabel="1">
          <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
        ...
        <attributeEditorField name="erstellungsjahr" index="9" showLabel="1">
          <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
            <labelFont strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="erhaltungsverantwortung_kategorie" index="10" showLabel="1">
          <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
            <labelFont strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="erhaltungsverantwortung_name" index="11" showLabel="1">
          <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
            <labelFont strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="zustand" index="12" showLabel="1">
          <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
            <labelFont strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="zustandsbeurteilung_jahr" index="13" showLabel="1">
          <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
            <labelFont strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="bemerkungen" index="14" showLabel="1">
          <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
            <labelFont strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="wirksamkeit" index="15" showLabel="1">
          <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
            <labelFont strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
      ...
      <attributeEditorContainer name="Bauwerkspezifisch" groupBox="1" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" collapsed="0" columnCount="1" collapsedExpression="" visibilityExpression="" showLabel="1">
        ...
        <attributeEditorField name="laenge" index="2" showLabel="1">
          <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
            <labelFont strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="breite" index="3" showLabel="1">
          <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
            <labelFont strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="hoehe_zum_umland" index="4" showLabel="1">
          <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
            <labelFont strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
    ...
    <attributeEditorContainer name="Dokumente zum Bauwerk" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" collapsed="0" columnCount="1" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorRelation name="schutzbaute_dokument_schutzbaute_wasser_damm_wasser_damm_T_Id" forceSuppressFormPopup="0" label="" nmRelationId="schutzbaute_dokument_dokument_dokument_T_Id" showLabel="1" relation="schutzbaute_dokument_schutzbaute_wasser_damm_wasser_damm_T_Id" relationWidgetTypeId="linking_relation_editor">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
