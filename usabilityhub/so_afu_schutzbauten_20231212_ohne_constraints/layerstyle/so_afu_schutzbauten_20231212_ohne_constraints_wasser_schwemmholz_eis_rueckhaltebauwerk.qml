...
<qgis styleCategories="LayerConfiguration|Symbology|Fields|Forms|CustomProperties|GeometryOptions" version="3.28.6-Firenze" readOnly="0">
  ...
  <renderer-v2 enableorderby="0" symbollevels="0" forceraster="0" referencescale="-1" type="singleSymbol">
    <symbols>
      <symbol force_rhr="0" alpha="1" is_animated="0" frame_rate="10" clip_to_extent="1" name="0" type="line">
        ...
        <layer enabled="1" id="{e36e58a4-e694-4e6e-9693-2bbed61eb00a}" locked="0" pass="0" class="SimpleLine">
          <Option type="Map">
            ...
            <Option value="89,87,255,255,rgb:0.34901960784313724,0.3411764705882353,1,1" name="line_color" type="QString"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="Wasser_Schwemmholz_Eis_Rueckhaltebauwerk_Art_c631685f_97e6_474a_8326_7f61f1fff755" name="Layer" type="QString"/>
            <Option value="Wasser_Schwemmholz_Eis_Rueckhaltebauwerk_Art" name="LayerName" type="QString"/>
            <Option value="ogr" name="LayerProviderName" type="QString"/>
            <Option value="/home/bjsvwweb/Schreibtisch/20240703-4.gpkg|layername=wasser_schwemmholz_eis_rueckhaltebauwerk_art" name="LayerSource" type="QString"/>
  ...
  <aliases>
    ...
    <alias field="hoehe" name="Höhe [m]" index="4"/>
    <alias field="rueckhaltevolumen" name="Rückhaltevolumen [m3]" index="5"/>
    <alias field="weiterer_prozess_rutschung" name="weiterer Prozess Rutschung" index="6"/>
    <alias field="weiterer_prozess_sturz" name="weiterer Prozess Sturz" index="7"/>
    <alias field="schutzbauten_id" name="Schutzbauten ID" index="8"/>
    <alias field="material" name="Material" index="9"/>
    <alias field="erstellungsjahr" name="Erstellungsjahr [Y]" index="10"/>
    <alias field="erhaltungsverantwortung_kategorie" name="Erhaltungsverantwortung Kategorie" index="11"/>
    <alias field="erhaltungsverantwortung_name" name="Erhaltungsverantwortung Name" index="12"/>
    <alias field="zustand" name="Zustand" index="13"/>
    <alias field="zustandsbeurteilung_jahr" name="Zustandsbeurteilung Jahr [Y]" index="14"/>
  ...
  <constraints>
    ...
    <constraint constraints="1" notnull_strength="2" field="breite" exp_strength="0" unique_strength="0"/>
    <constraint constraints="1" notnull_strength="2" field="hoehe" exp_strength="0" unique_strength="0"/>
    <constraint constraints="1" notnull_strength="2" field="rueckhaltevolumen" exp_strength="0" unique_strength="0"/>
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer horizontalStretch="0" visibilityExpression="" columnCount="2" collapsedExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" name="Übersicht" verticalStretch="0" type="Tab" collapsedExpressionEnabled="0">
      ...
      <attributeEditorContainer horizontalStretch="0" visibilityExpression="" columnCount="1" collapsedExpression="" showLabel="1" collapsed="0" groupBox="1" visibilityExpressionEnabled="0" name="Allgemein" verticalStretch="0" type="GroupBox" collapsedExpressionEnabled="0">
        ...
        <attributeEditorContainer horizontalStretch="0" visibilityExpression="" columnCount="2" collapsedExpression="" showLabel="1" collapsed="0" groupBox="1" visibilityExpressionEnabled="0" name="Weitere Prozesse" verticalStretch="0" type="GroupBox" collapsedExpressionEnabled="0">
          ...
          <attributeEditorField horizontalStretch="0" showLabel="1" name="weiterer_prozess_rutschung" verticalStretch="0" index="6">
            <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
              <labelFont description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" bold="0" underline="0" style=""/>
            </labelStyle>
          </attributeEditorField>
          <attributeEditorField horizontalStretch="0" showLabel="1" name="weiterer_prozess_sturz" verticalStretch="0" index="7">
            <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
              <labelFont description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" bold="0" underline="0" style=""/>
            </labelStyle>
          </attributeEditorField>
        </attributeEditorContainer>
        <attributeEditorField horizontalStretch="0" showLabel="1" name="schutzbauten_id" verticalStretch="0" index="8">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
            <labelFont description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" showLabel="1" name="material" verticalStretch="0" index="9">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
            <labelFont description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" showLabel="1" name="erstellungsjahr" verticalStretch="0" index="10">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
            <labelFont description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" showLabel="1" name="erhaltungsverantwortung_kategorie" verticalStretch="0" index="11">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
            <labelFont description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" showLabel="1" name="erhaltungsverantwortung_name" verticalStretch="0" index="12">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
            <labelFont description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" showLabel="1" name="zustand" verticalStretch="0" index="13">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
            <labelFont description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" showLabel="1" name="zustandsbeurteilung_jahr" verticalStretch="0" index="14">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
            <labelFont description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" showLabel="1" name="bemerkungen" verticalStretch="0" index="15">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
            <labelFont description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" showLabel="1" name="wirksamkeit" verticalStretch="0" index="16">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
            <labelFont description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
      ...
      <attributeEditorContainer horizontalStretch="0" visibilityExpression="" columnCount="1" collapsedExpression="" showLabel="1" collapsed="0" groupBox="1" visibilityExpressionEnabled="0" name="Bauwerkspezifisch" verticalStretch="0" type="GroupBox" collapsedExpressionEnabled="0">
        ...
        <attributeEditorField horizontalStretch="0" showLabel="1" name="breite" verticalStretch="0" index="3">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
            <labelFont description="DejaVu Sans,11,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" showLabel="1" name="hoehe" verticalStretch="0" index="4">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
            <labelFont description="DejaVu Sans,11,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" showLabel="1" name="rueckhaltevolumen" verticalStretch="0" index="5">
          <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="0,0,0,255,rgb:0,0,0,1">
            <labelFont description="DejaVu Sans,11,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" bold="0" underline="0" style=""/>
          </labelStyle>
        </attributeEditorField>
    ...
    <attributeEditorContainer horizontalStretch="0" visibilityExpression="" columnCount="1" collapsedExpression="" showLabel="1" collapsed="0" groupBox="0" visibilityExpressionEnabled="0" name="Dokumente zum Bauwerk" verticalStretch="0" type="Tab" collapsedExpressionEnabled="0">
      ...
      <attributeEditorRelation horizontalStretch="0" nmRelationId="schutzbaute_dokument_dokument_dokument_T_Id" relationWidgetTypeId="linking_relation_editor" showLabel="1" relation="schutzbaute_dokument_schutzbaute_wasser_schwemmholz_eis_rueckhaltebauwerk_wasser_schwemmholz_eis_rueckhaltebauwerk_T_Id" forceSuppressFormPopup="0" name="schutzbaute_dokument_schutzbaute_wasser_schwemmholz_eis_rueckhaltebauwerk_wasser_schwemmholz_eis_rueckhaltebauwerk_T_Id" verticalStretch="0" label="">
        <labelStyle overrideLabelColor="0" overrideLabelFont="0" labelColor="">
          <labelFont description="Ubuntu,11,-1,5,50,0,0,0,0,0" italic="0" strikethrough="0" bold="0" underline="0" style=""/>
        </labelStyle>
  ...
  <widgets>
    <widget name="schutzbaute_dokument_schutzbaute_wasser_schwemmholz_eis_rueckhaltebauwerk_wasser_rueckhaltebauwerk_T_Id">
      <config type="Map">
        <Option value="schutzbaute_dokument_dokument_dokument_T_Id" name="nm-rel" type="QString"/>
      </config>
    </widget>
    <widget name="schutzbaute_dokument_schutzbaute_wasser_schwemmholz_eis_rueckhaltebauwerk_wasser_schwemmholz_eis_rueckhaltebauwerk_T_Id">
      <config type="Map">
        <Option value="schutzbaute_dokument_dokument_dokument_T_Id" name="nm-rel" type="QString"/>
      </config>
    </widget>
