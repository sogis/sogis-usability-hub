...
<qgis styleCategories="LayerConfiguration|Symbology|Fields|Forms|CustomProperties|GeometryOptions" version="3.28.6-Firenze" readOnly="0">
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option name="Layer" type="QString" value="Wasser_Rueckhaltebauwerk_Art_a8818608_5e31_4510_84f5_b22f29f770b8"/>
            <Option name="LayerName" type="QString" value="Wasser_Rueckhaltebauwerk_Art"/>
  ...
  <aliases>
    ...
    <alias name="Rueckhaltevolumen" index="5" field="rueckhaltevolumen"/>
    <alias name="weiterer_Prozess_Rutschung" index="6" field="weiterer_prozess_rutschung"/>
    <alias name="weiterer_Prozess_Sturz" index="7" field="weiterer_prozess_sturz"/>
    <alias name="Schutzbauten_ID" index="8" field="schutzbauten_id"/>
    <alias name="Material" index="9" field="material"/>
    <alias name="Erstellungsjahr" index="10" field="erstellungsjahr"/>
    <alias name="Erhaltungsverantwortung_Kategorie" index="11" field="erhaltungsverantwortung_kategorie"/>
    <alias name="Erhaltungsverantwortung_Name" index="12" field="erhaltungsverantwortung_name"/>
    <alias name="Zustand" index="13" field="zustand"/>
    <alias name="Zustandsbeurteilung_Jahr" index="14" field="zustandsbeurteilung_jahr"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="2" unique_strength="0" exp_strength="0" constraints="1" field="rueckhaltevolumen"/>
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer name="Übersicht" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" collapsed="0" columnCount="2" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorContainer name="Bauwerkspezifisch" groupBox="1" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" collapsed="0" columnCount="1" collapsedExpression="" visibilityExpression="" showLabel="1">
        ...
        <attributeEditorField name="rueckhaltevolumen" index="5" showLabel="1">
          <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
            <labelFont strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
    ...
    <attributeEditorContainer name="Dokumente zum Bauwerk" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" collapsed="0" columnCount="1" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorRelation name="schutzbaute_dokument_schutzbaute_wasser_rueckhaltebauwerk_wasser_rueckhaltebauwerk_T_Id" forceSuppressFormPopup="0" label="" nmRelationId="schutzbaute_dokument_dokument_dokument_T_Id" showLabel="1" relation="schutzbaute_dokument_schutzbaute_wasser_rueckhaltebauwerk_wasser_rueckhaltebauwerk_T_Id" relationWidgetTypeId="linking_relation_editor">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
