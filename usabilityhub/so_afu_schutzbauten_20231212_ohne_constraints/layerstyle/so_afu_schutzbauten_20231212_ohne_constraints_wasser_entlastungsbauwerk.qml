...
<qgis styleCategories="LayerConfiguration|Symbology|Fields|Forms|CustomProperties|GeometryOptions" version="3.28.6-Firenze" readOnly="0">
  ...
  <aliases>
    ...
    <alias name="weiterer Prozess Rutschung" index="3" field="weiterer_prozess_rutschung"/>
    <alias name="weiterer Prozess Sturz" index="4" field="weiterer_prozess_sturz"/>
    <alias name="Schutzbauten ID" index="5" field="schutzbauten_id"/>
    <alias name="Material" index="6" field="material"/>
    <alias name="Erstellungsjahr [Y]" index="7" field="erstellungsjahr"/>
    <alias name="Erhaltungsverantwortung Kategorie" index="8" field="erhaltungsverantwortung_kategorie"/>
    <alias name="Erhaltungsverantwortung Name" index="9" field="erhaltungsverantwortung_name"/>
    <alias name="Zustand" index="10" field="zustand"/>
    <alias name="Zustandsbeurteilung Jahr [Y]" index="11" field="zustandsbeurteilung_jahr"/>
    <alias name="Bemerkungen" index="12" field="bemerkungen"/>
    <alias name="Wirksamkeit" index="13" field="wirksamkeit"/>
  </aliases>
  <defaults>
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer name="Übersicht" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" collapsed="0" columnCount="2" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorContainer name="Allgemein" groupBox="1" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" collapsed="0" columnCount="1" collapsedExpression="" visibilityExpression="" showLabel="1">
        ...
        <attributeEditorContainer name="Weitere Prozesse" groupBox="1" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" collapsed="0" columnCount="2" collapsedExpression="" visibilityExpression="" showLabel="1">
          ...
          <attributeEditorField name="weiterer_prozess_rutschung" index="3" showLabel="1">
            <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
              <labelFont strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
            </labelStyle>
          </attributeEditorField>
          <attributeEditorField name="weiterer_prozess_sturz" index="4" showLabel="1">
            <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
              <labelFont strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
            </labelStyle>
          </attributeEditorField>
        </attributeEditorContainer>
        <attributeEditorField name="schutzbauten_id" index="5" showLabel="1">
          <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
        ...
        <attributeEditorField name="erstellungsjahr" index="7" showLabel="1">
          <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
            <labelFont strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="erhaltungsverantwortung_kategorie" index="8" showLabel="1">
          <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
            <labelFont strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="erhaltungsverantwortung_name" index="9" showLabel="1">
          <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
            <labelFont strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="zustand" index="10" showLabel="1">
          <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
            <labelFont strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="zustandsbeurteilung_jahr" index="11" showLabel="1">
          <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
            <labelFont strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="bemerkungen" index="12" showLabel="1">
          <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
            <labelFont strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField name="wirksamkeit" index="13" showLabel="1">
          <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
            <labelFont strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
          </labelStyle>
        </attributeEditorField>
    ...
    <attributeEditorContainer name="Dokumente zum Bauwerk" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" collapsed="0" columnCount="1" collapsedExpression="" visibilityExpression="" showLabel="1">
      ...
      <attributeEditorRelation name="schutzbaute_dokument_schutzbaute_wasser_entlastungsbauwerk_wasser_entlastungsbauwerk_T_Id" forceSuppressFormPopup="0" label="" nmRelationId="schutzbaute_dokument_dokument_dokument_T_Id" showLabel="1" relation="schutzbaute_dokument_schutzbaute_wasser_entlastungsbauwerk_wasser_entlastungsbauwerk_T_Id" relationWidgetTypeId="linking_relation_editor">
        <labelStyle overrideLabelColor="0" labelColor="0,0,0,255" overrideLabelFont="0">
          <labelFont strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" underline="0" bold="0" style=""/>
        </labelStyle>
