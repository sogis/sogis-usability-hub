...
<qgis readOnly="0" styleCategories="LayerConfiguration|Symbology|Fields|Forms|CustomProperties|GeometryOptions" version="3.28.6-Firenze">
  ...
  <aliases>
    ...
    <alias index="5" name="Hoehe_zum_Umland" field="hoehe_zum_umland"/>
    <alias index="6" name="Flaeche" field="flaeche"/>
    <alias index="7" name="Rueckhaltevolumen" field="rueckhaltevolumen"/>
    <alias index="8" name="weiterer_Prozess_Rutschung" field="weiterer_prozess_rutschung"/>
    ...
    <alias index="12" name="Erstellungsjahr" field="erstellungsjahr"/>
    ...
    <alias index="16" name="Zustandsbeurteilung_Jahr" field="zustandsbeurteilung_jahr"/>
