...
<qgis styleCategories="LayerConfiguration|Symbology|Fields|Forms|CustomProperties|GeometryOptions" version="3.28.6-Firenze" readOnly="0">
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="Wasser_Rampe_Sohlensicherung_Art_60f12af7_8ef5_40a7_b3db_ee634a0c3650" type="QString" name="Layer"/>
            <Option value="Wasser_Rampe_Sohlensicherung_Art" type="QString" name="LayerName"/>
  ...
  <aliases>
    ...
    <alias index="2" field="art" name="Art"/>
    <alias index="3" field="laenge" name="Länge [m]"/>
    <alias index="4" field="breite" name="Breite [m]"/>
    <alias index="5" field="weiterer_prozess_rutschung" name="weiterer Prozess Rutschung"/>
    <alias index="6" field="weiterer_prozess_sturz" name="weiterer Prozess Sturz"/>
    <alias index="7" field="schutzbauten_id" name="Schutzbauten ID"/>
    <alias index="8" field="material" name="Material"/>
    <alias index="9" field="erstellungsjahr" name="Erstellungsjahr [Y]"/>
    <alias index="10" field="erhaltungsverantwortung_kategorie" name="Erhaltungsverantwortung Kategorie"/>
    <alias index="11" field="erhaltungsverantwortung_name" name="Erhaltungsverantwortung Name"/>
    <alias index="12" field="zustand" name="Zustand"/>
    <alias index="13" field="zustandsbeurteilung_jahr" name="Zustandsbeurteilung Jahr [Y]"/>
    <alias index="14" field="bemerkungen" name="Bemerkungen"/>
    <alias index="15" field="wirksamkeit" name="Wirksamkeit"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint constraints="1" unique_strength="0" field="art" notnull_strength="2" exp_strength="0"/>
    <constraint constraints="1" unique_strength="0" field="laenge" notnull_strength="2" exp_strength="0"/>
    <constraint constraints="1" unique_strength="0" field="breite" notnull_strength="2" exp_strength="0"/>
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer visibilityExpressionEnabled="0" showLabel="1" collapsedExpression="" collapsedExpressionEnabled="0" columnCount="2" groupBox="0" visibilityExpression="" collapsed="0" name="Übersicht">
      ...
      <attributeEditorContainer visibilityExpressionEnabled="0" showLabel="1" collapsedExpression="" collapsedExpressionEnabled="0" columnCount="1" groupBox="1" visibilityExpression="" collapsed="0" name="Allgemein">
        ...
        <attributeEditorContainer visibilityExpressionEnabled="0" showLabel="1" collapsedExpression="" collapsedExpressionEnabled="0" columnCount="2" groupBox="1" visibilityExpression="" collapsed="0" name="Weitere Prozesse">
          ...
          <attributeEditorField index="5" showLabel="1" name="weiterer_prozess_rutschung">
            <labelStyle overrideLabelFont="0" labelColor="0,0,0,255" overrideLabelColor="0">
              <labelFont underline="0" style="" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" bold="0"/>
            </labelStyle>
          </attributeEditorField>
          <attributeEditorField index="6" showLabel="1" name="weiterer_prozess_sturz">
            <labelStyle overrideLabelFont="0" labelColor="0,0,0,255" overrideLabelColor="0">
              <labelFont underline="0" style="" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" bold="0"/>
            </labelStyle>
          </attributeEditorField>
        </attributeEditorContainer>
        <attributeEditorField index="7" showLabel="1" name="schutzbauten_id">
          <labelStyle overrideLabelFont="0" labelColor="0,0,0,255" overrideLabelColor="0">
            <labelFont underline="0" style="" strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField index="8" showLabel="1" name="material">
          <labelStyle overrideLabelFont="0" labelColor="0,0,0,255" overrideLabelColor="0">
            <labelFont underline="0" style="" strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField index="9" showLabel="1" name="erstellungsjahr">
          <labelStyle overrideLabelFont="0" labelColor="0,0,0,255" overrideLabelColor="0">
            <labelFont underline="0" style="" strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField index="10" showLabel="1" name="erhaltungsverantwortung_kategorie">
          <labelStyle overrideLabelFont="0" labelColor="0,0,0,255" overrideLabelColor="0">
            <labelFont underline="0" style="" strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField index="11" showLabel="1" name="erhaltungsverantwortung_name">
          <labelStyle overrideLabelFont="0" labelColor="0,0,0,255" overrideLabelColor="0">
            <labelFont underline="0" style="" strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField index="12" showLabel="1" name="zustand">
          <labelStyle overrideLabelFont="0" labelColor="0,0,0,255" overrideLabelColor="0">
            <labelFont underline="0" style="" strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField index="13" showLabel="1" name="zustandsbeurteilung_jahr">
          <labelStyle overrideLabelFont="0" labelColor="0,0,0,255" overrideLabelColor="0">
            <labelFont underline="0" style="" strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField index="14" showLabel="1" name="bemerkungen">
          <labelStyle overrideLabelFont="0" labelColor="0,0,0,255" overrideLabelColor="0">
            <labelFont underline="0" style="" strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField index="15" showLabel="1" name="wirksamkeit">
          <labelStyle overrideLabelFont="0" labelColor="0,0,0,255" overrideLabelColor="0">
            <labelFont underline="0" style="" strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
      ...
      <attributeEditorContainer visibilityExpressionEnabled="0" showLabel="1" collapsedExpression="" collapsedExpressionEnabled="0" columnCount="1" groupBox="1" visibilityExpression="" collapsed="0" name="Bauwerkspezifisch">
        ...
        <attributeEditorField index="2" showLabel="1" name="art">
          <labelStyle overrideLabelFont="0" labelColor="0,0,0,255" overrideLabelColor="0">
            <labelFont underline="0" style="" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField index="3" showLabel="1" name="laenge">
          <labelStyle overrideLabelFont="0" labelColor="0,0,0,255" overrideLabelColor="0">
            <labelFont underline="0" style="" strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField index="4" showLabel="1" name="breite">
          <labelStyle overrideLabelFont="0" labelColor="0,0,0,255" overrideLabelColor="0">
            <labelFont underline="0" style="" strikethrough="0" description="DejaVu Sans,8.25,-1,5,50,0,0,0,0,0" italic="0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
    ...
    <attributeEditorContainer visibilityExpressionEnabled="0" showLabel="1" collapsedExpression="" collapsedExpressionEnabled="0" columnCount="1" groupBox="0" visibilityExpression="" collapsed="0" name="Dokumente zum Bauwerk">
      ...
      <attributeEditorRelation showLabel="1" label="" forceSuppressFormPopup="0" relation="schutzbaute_dokument_schutzbaute_wasser_rampe_sohlensicherung_wasser_rampe_sohlensicherung_T_Id" nmRelationId="schutzbaute_dokument_dokument_dokument_T_Id" relationWidgetTypeId="linking_relation_editor" name="schutzbaute_dokument_schutzbaute_wasser_rampe_sohlensicherung_wasser_rampe_sohlensicherung_T_Id">
        <labelStyle overrideLabelFont="0" labelColor="0,0,0,255" overrideLabelColor="0">
          <labelFont underline="0" style="" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" bold="0"/>
        </labelStyle>
