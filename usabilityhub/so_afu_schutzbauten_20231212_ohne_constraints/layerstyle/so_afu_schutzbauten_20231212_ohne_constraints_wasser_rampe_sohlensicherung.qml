...
<qgis styleCategories="LayerConfiguration|Symbology|Fields|Forms|CustomProperties|GeometryOptions" version="3.28.6-Firenze" readOnly="0">
  ...
  <aliases>
    ...
    <alias index="3" field="laenge" name="Laenge"/>
    <alias index="4" field="breite" name="Breite"/>
    <alias index="5" field="weiterer_prozess_rutschung" name="weiterer_Prozess_Rutschung"/>
    <alias index="6" field="weiterer_prozess_sturz" name="weiterer_Prozess_Sturz"/>
    <alias index="7" field="schutzbauten_id" name="Schutzbauten_ID"/>
    <alias index="8" field="material" name="Material"/>
    <alias index="9" field="erstellungsjahr" name="Erstellungsjahr"/>
    <alias index="10" field="erhaltungsverantwortung_kategorie" name="Erhaltungsverantwortung_Kategorie"/>
    <alias index="11" field="erhaltungsverantwortung_name" name="Erhaltungsverantwortung_Name"/>
    <alias index="12" field="zustand" name="Zustand"/>
    <alias index="13" field="zustandsbeurteilung_jahr" name="Zustandsbeurteilung_Jahr"/>
