...
<qgis styleCategories="LayerConfiguration|Symbology|Fields|Forms|CustomProperties|GeometryOptions" version="3.28.6-Firenze" readOnly="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" type="singleSymbol" referencescale="-1">
    <symbols>
      <symbol frame_rate="10" force_rhr="0" is_animated="0" type="line" alpha="1" clip_to_extent="1" name="0">
        ...
        <layer pass="0" enabled="1" locked="0" class="SimpleLine">
          <Option type="Map">
            ...
            <Option value="89,87,255,255" type="QString" name="line_color"/>
  ...
  <aliases>
    ...
    <alias index="2" field="laenge" name="Laenge"/>
    <alias index="3" field="breite" name="Breite"/>
    <alias index="4" field="hoehe" name="Hoehe"/>
    <alias index="5" field="hoehe_zum_umland" name="Hoehe_zum_Umland"/>
    <alias index="6" field="flaeche" name="Flaeche"/>
    <alias index="7" field="rueckhaltevolumen" name="Rueckhaltevolumen"/>
    <alias index="8" field="weiterer_prozess_rutschung" name="weiterer_Prozess_Rutschung"/>
    <alias index="9" field="weiterer_prozess_sturz" name="weiterer_Prozess_Sturz"/>
    <alias index="10" field="schutzbauten_id" name="Schutzbauten_ID"/>
    <alias index="11" field="material" name="Material"/>
    <alias index="12" field="erstellungsjahr" name="Erstellungsjahr"/>
    <alias index="13" field="erhaltungsverantwortung_kategorie" name="Erhaltungsverantwortung_Kategorie"/>
    <alias index="14" field="erhaltungsverantwortung_name" name="Erhaltungsverantwortung_Name"/>
    <alias index="15" field="zustand" name="Zustand"/>
    <alias index="16" field="zustandsbeurteilung_jahr" name="Zustandsbeurteilung_Jahr"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer visibilityExpressionEnabled="0" showLabel="1" collapsedExpression="" collapsedExpressionEnabled="0" columnCount="1" groupBox="0" visibilityExpression="" collapsed="0" name="Dokumente zum Bauwerk">
      ...
      <attributeEditorRelation showLabel="1" label="" forceSuppressFormPopup="0" relation="schutzbaute_dokument_schutzbaute_wasser_andere_werksart_linie_wasser_andere_werksart_linie_T_Id" nmRelationId="schutzbaute_dokument_dokument_dokument_T_Id" relationWidgetTypeId="linking_relation_editor" name="schutzbaute_dokument_schutzbaute_wasser_andere_werksart_linie_wasser_andere_werksart_linie_T_Id">
        <labelStyle overrideLabelFont="0" labelColor="0,0,0,255" overrideLabelColor="0">
          <labelFont underline="0" style="" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" bold="0"/>
        </labelStyle>
