...
<qgis readOnly="0" styleCategories="LayerConfiguration|Symbology|Fields|Forms|CustomProperties|GeometryOptions" version="3.28.6-Firenze">
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="ReferencedLayerDataSource" type="QString" value="//srsofaioi15496/xenusers$/bjsvwweb/Documents/02_Projekte/2075_Schutzbautenkataster/SO_AFU_Schutzbauten_20240206.gpkg|layername=wasser_entlastungsstollen_kanal_art"/>
            <Option name="ReferencedLayerId" type="QString" value="Wasser_Entlastungsstollen_kanal_Art_f75a9704_78a5_4ab8_95b0_c7a6c804b5ca"/>
            <Option name="ReferencedLayerName" type="QString" value="Wasser_Entlastungsstollen_kanal_Art"/>
            <Option name="ReferencedLayerProviderKey" type="QString" value="ogr"/>
            <Option name="Relation" type="QString" value="wasser_entlastungsstollen_kanal_art_wasser_entlastungsstollen_kanal_art_T_Id"/>
  ...
  <aliases>
    ...
    <alias name="Breite [m]" field="breite" index="4"/>
    <alias name="Hoehe [m]" field="hoehe" index="5"/>
