...
<qgis readOnly="0" styleCategories="LayerConfiguration|Symbology|Fields|Forms|CustomProperties|GeometryOptions" version="3.28.6-Firenze">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="singleSymbol" referencescale="-1" enableorderby="0">
    <symbols>
      <symbol name="0" type="fill" force_rhr="0" is_animated="0" clip_to_extent="1" frame_rate="10" alpha="1">
    ...
    <field name="flaeche" configurationFlags="None">
      <editWidget type="Range">
        <config>
          <Option type="Map">
            <Option name="AllowNull" type="bool" value="true"/>
            <Option name="Max" type="double" value="9999999"/>
    ...
    <field name="rueckhaltevolumen" configurationFlags="None">
      <editWidget type="Range">
        <config>
          <Option type="Map">
            <Option name="AllowNull" type="bool" value="true"/>
            <Option name="Max" type="double" value="999999999"/>
            <Option name="Min" type="double" value="1"/>
            <Option name="Precision" type="int" value="0"/>
            <Option name="Step" type="double" value="1"/>
            <Option name="Style" type="QString" value="SpinBox"/>
  ...
  <aliases>
    ...
    <alias name="Laenge [m]" field="laenge" index="2"/>
    <alias name="Breite [m]" field="breite" index="3"/>
    <alias name="Hoehe [m]" field="hoehe" index="4"/>
    <alias name="Hoehe_zum_Umland [m]" field="hoehe_zum_umland" index="5"/>
    <alias name="Flaeche [m2]" field="flaeche" index="6"/>
    <alias name="Rueckhaltevolumen [m3]" field="rueckhaltevolumen" index="7"/>
    <alias name="weiterer_Prozess_Wasser" field="weiterer_prozess_wasser" index="8"/>
    <alias name="weiterer_Prozess_Sturz" field="weiterer_prozess_sturz" index="9"/>
    ...
    <alias name="Zustandsbeurteilung_Jahr [Y]" field="zustandsbeurteilung_jahr" index="16"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" constraints="0" field="laenge" unique_strength="0" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" field="breite" unique_strength="0" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" field="hoehe" unique_strength="0" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" field="hoehe_zum_umland" unique_strength="0" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" field="flaeche" unique_strength="0" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" field="rueckhaltevolumen" unique_strength="0" exp_strength="0"/>
