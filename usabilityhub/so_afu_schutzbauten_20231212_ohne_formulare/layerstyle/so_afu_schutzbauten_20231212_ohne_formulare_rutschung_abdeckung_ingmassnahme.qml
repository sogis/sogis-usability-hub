...
<qgis readOnly="0" styleCategories="LayerConfiguration|Symbology|Fields|Forms|CustomProperties|GeometryOptions" version="3.28.6-Firenze">
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="ReferencedLayerDataSource" type="QString" value="//srsofaioi15496/xenusers$/bjsvwweb/Documents/02_Projekte/2075_Schutzbautenkataster/SO_AFU_Schutzbauten_20240206.gpkg|layername=rutschung_abdeckung_ingmassnahme_art"/>
            <Option name="ReferencedLayerId" type="QString" value="Rutschung_Abdeckung_IngMassnahme_Art_bb123720_0ec1_45bc_aed5_d3d545a8035e"/>
            <Option name="ReferencedLayerName" type="QString" value="Rutschung_Abdeckung_IngMassnahme_Art"/>
  ...
  <aliases>
    ...
    <alias name="Flaeche [m2]" field="flaeche" index="3"/>
    <alias name="weiterer_Prozess_Wasser" field="weiterer_prozess_wasser" index="4"/>
    <alias name="weiterer_Prozess_Sturz" field="weiterer_prozess_sturz" index="5"/>
    ...
    <alias name="Zustandsbeurteilung_Jahr [Y]" field="zustandsbeurteilung_jahr" index="12"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" constraints="1" field="flaeche" unique_strength="0" exp_strength="0"/>
