...
<qgis readOnly="0" styleCategories="LayerConfiguration|Symbology|Fields|Forms|CustomProperties|GeometryOptions" version="3.28.6-Firenze">
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option name="ReferencedLayerDataSource" type="QString" value="//srsofaioi15496/xenusers$/bjsvwweb/Documents/02_Projekte/2075_Schutzbautenkataster/SO_AFU_Schutzbauten_20240206.gpkg|layername=wasser_rueckhaltebauwerk_art"/>
            <Option name="ReferencedLayerId" type="QString" value="Wasser_Rueckhaltebauwerk_Art_5546f02d_3fcc_405d_9b9c_fcc21e455b4a"/>
            <Option name="ReferencedLayerName" type="QString" value="Wasser_Rueckhaltebauwerk_Art"/>
            <Option name="ReferencedLayerProviderKey" type="QString" value="ogr"/>
            <Option name="Relation" type="QString" value="wasser_rueckhaltebauwerk_art_wasser_rueckhaltebauwerk_art_T_Id"/>
  ...
  <aliases>
    ...
    <alias name="Rueckhaltevolumen [m3]" field="rueckhaltevolumen" index="5"/>
    <alias name="weiterer_Prozess_Rutschung" field="weiterer_prozess_rutschung" index="6"/>
    <alias name="weiterer_Prozess_Sturz" field="weiterer_prozess_sturz" index="7"/>
    <alias name="Schutzbauten_ID" field="schutzbauten_id" index="8"/>
    <alias name="Material" field="material" index="9"/>
    <alias name="Erstellungsjahr [Y]" field="erstellungsjahr" index="10"/>
    <alias name="Erhaltungsverantwortung_Kategorie" field="erhaltungsverantwortung_kategorie" index="11"/>
    <alias name="Erhaltungsverantwortung_Name" field="erhaltungsverantwortung_name" index="12"/>
    <alias name="Zustand" field="zustand" index="13"/>
    <alias name="Zustandsbeurteilung_Jahr [Y]" field="zustandsbeurteilung_jahr" index="14"/>
    <alias name="Bemerkungen" field="bemerkungen" index="15"/>
    <alias name="Wirksamkeit" field="wirksamkeit" index="16"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint notnull_strength="1" constraints="1" field="breite" unique_strength="0" exp_strength="0"/>
    <constraint notnull_strength="1" constraints="1" field="hoehe" unique_strength="0" exp_strength="0"/>
    <constraint notnull_strength="1" constraints="1" field="rueckhaltevolumen" unique_strength="0" exp_strength="0"/>
