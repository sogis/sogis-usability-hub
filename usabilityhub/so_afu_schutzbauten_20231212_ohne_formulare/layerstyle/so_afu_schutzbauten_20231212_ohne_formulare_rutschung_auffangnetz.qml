...
<qgis readOnly="0" styleCategories="LayerConfiguration|Symbology|Fields|Forms|CustomProperties|GeometryOptions" version="3.28.6-Firenze">
  ...
  <aliases>
    ...
    <alias name="weiterer_Prozess_Wasser" field="weiterer_prozess_wasser" index="3"/>
    <alias name="weiterer_Prozess_Sturz" field="weiterer_prozess_sturz" index="4"/>
    <alias name="Schutzbauten_ID" field="schutzbauten_id" index="5"/>
    <alias name="Material" field="material" index="6"/>
    <alias name="Erstellungsjahr [Y]" field="erstellungsjahr" index="7"/>
    <alias name="Erhaltungsverantwortung_Kategorie" field="erhaltungsverantwortung_kategorie" index="8"/>
    <alias name="Erhaltungsverantwortung_Name" field="erhaltungsverantwortung_name" index="9"/>
    <alias name="Zustand" field="zustand" index="10"/>
    <alias name="Zustandsbeurteilung_Jahr [Y]" field="zustandsbeurteilung_jahr" index="11"/>
    <alias name="Bemerkungen" field="bemerkungen" index="12"/>
    <alias name="Wirksamkeit" field="wirksamkeit" index="13"/>
  </aliases>
  <defaults>
